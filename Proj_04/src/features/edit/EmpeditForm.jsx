...
const EmpeditForm = () => {
  ...
  return (
    <div onClick={() => dispatch(closeEdittab())} className=' fixed top-4 w-full h-full bg-black/80 flex items-center justify-center z-20'>
      <form onClick={(e) => e.stopPropagation()} className=" max-w-sm mx-auto border w-sm p-4 rounded-lg">
        ...
        <textarea id="message" rows="4" className=" mb-1.5 bg-base-100 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full p-3.5 shadow-xs placeholder:text-body" placeholder="Write your thoughts here..."></textarea>
